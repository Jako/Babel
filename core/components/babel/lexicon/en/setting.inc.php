...
$_lang['setting_babel.debug_desc'] = 'Log debug information in the MODX error log.';
$_lang['setting_babel.displayChunk'] = 'Context Text Template';
$_lang['setting_babel.displayChunk_desc'] = 'Name of a chunk that is the template for the text shown in the Babel button for each context.';
$_lang['setting_babel.displayText'] = 'Context Text';
$_lang['setting_babel.displayText_desc'] = 'Text shown in the Babel button for each context. You can use the following values: \'language\', \'context\', \'combination\' or \'chunk\'';
$_lang['setting_babel.restrictToGroup'] = 'Restrict To Group';
