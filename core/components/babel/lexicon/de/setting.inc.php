...
$_lang['setting_babel.debug_desc'] = 'Debug-Informationen im MODX Fehlerprotokoll ausgeben.';
$_lang['setting_babel.displayChunk'] = 'Kontext-Text Template';
$_lang['setting_babel.displayChunk_desc'] = 'Name eines Chunks, der als Template für den Text dient, der in der Babel-Schaltfläche für jeden Kontext angezeigt wird.';
$_lang['setting_babel.displayText'] = 'Kontext-Text';
$_lang['setting_babel.displayText_desc'] = 'Text, der auf der Babel-Schaltfläche für jeden Kontext angezeigt wird. Sie können die folgenden Werte verwenden: \'language\', \'context\', \'combination\' oder \'chunk\'';
$_lang['setting_babel.restrictToGroup'] = 'Auf Gruppe beschränken';
