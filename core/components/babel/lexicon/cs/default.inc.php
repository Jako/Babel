...
$_lang['babel.update'] = 'Aktualizace';
$_lang['babel.update_child_translations'] = 'Aktualizovat překlady dětských zdrojů';
$_lang['babel.update_multiple_translations'] = 'Aktualizace více překladů';
$_lang['babel.update_multiple_translations_err_no_contexts'] = 'Pro aktualizaci překladů nejsou k dispozici žádné další kontexty.';
$_lang['babel.update_multiple_translations_finished'] = 'Přeložené zdroje byly aktualizovány.';
$_lang['babel.update_translation'] = 'Aktualizace překladu';
$_lang['babel.update_translation_confirm'] = 'Jste si jisti, že chcete aktualizovat překlad tohoto zdroje v kontextu <b>"[[+kontext]]"</b>?';
