 ...
 */
$_lang['babel'] = 'Babel';
$_lang['babel.about'] = 'O společnosti Babel';
$_lang['babel.all'] = 'Vše';
$_lang['babel.context_err_invalid_key'] = '[[+context]] není platný klíč kontextu.';
$_lang['babel.context_err_ns'] = 'Kontext nebyl specifikován.';
...
$_lang['babel.contexts_desc_delete'] = 'Odstranit zdroj';
$_lang['babel.contexts_desc_delete_all'] = 'Odstranění všech propojených prostředků';
...
$_lang['babel.create_child_translations'] = 'Vytvořit překlady dětských zdrojů';
$_lang['babel.create_multiple_translations'] = 'Vytvořit více překladů';
$_lang['babel.create_multiple_translations_err_no_contexts'] = 'Pro vytváření překladů nejsou k dispozici žádné kontexty.';
$_lang['babel.create_multiple_translations_finished'] = 'Byly vytvořeny přeložené zdroje.';
...
$_lang['babel.delete'] = 'Odstranit';
$_lang['babel.delete_all'] = 'Odstranit vše';
$_lang['babel.delete_all_translations'] = 'Odstranění všech překladů';
$_lang['babel.delete_all_translations_confirm'] = 'Opravdu chcete odstranit všechny překlady z tohoto zdroje?';
$_lang['babel.delete_child_translations'] = 'Odstranění překladů podřízených zdrojů';
$_lang['babel.delete_multiple_translations_finished'] = 'Přeložené zdroje byly odstraněny.';
$_lang['babel.delete_successful'] = 'Překlad byl úspěšně smazán.';
$_lang['babel.delete_translation'] = 'Odstranit překlad';
$_lang['babel.delete_translation_confirm'] = 'Jste si jisti, že chcete odstranit překlad z tohoto zdroje v kontextu <b>"[[+context]]"</b>?';
$_lang['babel.desc'] = 'Správa vícejazyčného systému';
$_lang['babel.link_successful'] = 'Zdroj byl úspěšně propojen.';
$_lang['babel.link_translation'] = 'Odkaz na existující zdroj';
$_lang['babel.open'] = 'Otevřeno';
$_lang['babel.please_wait'] = 'Počkejte prosím …';
$_lang['babel.refresh'] = 'Aktualizace';
$_lang['babel.refresh_cache'] = 'Vymazání mezipaměti [[+jméno balíčku]]';
$_lang['babel.refresh_child_translations'] = 'Aktualizovat překlady dětských zdrojů';
$_lang['babel.refresh_multiple_translations'] = 'Aktualizace více překladů';
$_lang['babel.refresh_multiple_translations_err_no_contexts'] = 'Pro obnovení překladů nejsou k dispozici žádné kontexty.';
$_lang['babel.refresh_multiple_translations_finished'] = 'Přeložené zdroje byly aktualizovány.';
$_lang['babel.refresh_translation'] = 'Aktualizace překladu';
$_lang['babel.refresh_translation_confirm'] = 'Jste si jisti, že chcete aktualizovat překlad tohoto zdroje v kontextu <b>"[[+context]]"</b>?';
...
$_lang['babel.resource_err_link_of_selflink_not_possible'] = 'Odkaz na samotný prostředek nelze propojit.';
$_lang['babel.search'] = 'Vyhledávání …';
$_lang['babel.select_context'] = 'Vyberte kontext';
...
$_lang['babel.success_delete_resource'] = 'Přeložený prostředek [[+oldid]] prostředku [[+id]] byl odstraněn v kontextu [[+context]].';
...
$_lang['babel.success_sync_resource'] = 'Přeložený prostředek [[+newid]] prostředku [[+id]] byl synchronizován v kontextu [[+context]].';
$_lang['babel.success_unlink_resource'] = 'Přeložený prostředek [[+oldid]] prostředku [[+id]] byl v kontextu [[+context]] odpojen.';
$_lang['babel.success_unlink_resources'] = 'Přeložené prostředky zdroje [[+id]] byly ve všech souvislostech odpojeny.';
$_lang['babel.sync_linked_translations'] = 'Synchronizovat všechny překlady';
$_lang['babel.sync_linked_translations_target'] = 'Synchronizovat všechny překlady z cílového';
...
$_lang['babel.translation_err_could_not_sync_resource'] = 'Při pokusu o synchronizaci překladu v kontextu [[+context]] došlo k chybě.';
...
$_lang['babel.unlink_multiple_translations_finished'] = 'Přeložené zdroje byly odpojeny.';
$_lang['babel.unlink_successful'] = 'Překlad byl úspěšně odpojen.';
$_lang['babel.unlink_translation'] = 'Odpojení překladu';
$_lang['babel.unlink_translation_confirm'] = 'Jste si jisti, že chcete zrušit propojení překladu z tohoto zdroje s kontextem <b>"[[+context]]"</b>?';
